...
export default function DetalhesSolicitacao() {
  ...
  const [detalhes, setDetalhes] = useState<SolicitacaoDetalhe | null>(null);
    ...
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        <View style={styles.header}>
          <Text style={styles.title}>Solicitação #{detalhes.id}</Text>
          <View style={styles.badge}>
            <Text style={styles.badgeText}>{detalhes.status}</Text>
          </View>
        </View>
        <View style={styles.body}>
          <View style={styles.infoPrincipal}>
            ...
            <View>
              <Text style={styles.nome}>{detalhes.profissional.nome}</Text>
              <Text style={styles.email}>{detalhes.profissional.email}</Text>
            </View>
          </View>
          <View style={styles.gridContatos}>
            <View style={styles.itemContato}>
              <FontAwesome5 name="phone" size={16} color="#28a745" />
              <Text>{detalhes.profissional.telefone}</Text>
            </View>
            <View style={styles.itemContato}>
              <FontAwesome5 name="map-marker-alt" size={16} color="#dc3545" />
              <Text>{detalhes.enderecoServico}</Text>
            </View>
          </View>
        ...
        <View style={styles.footer}>
          <TouchableOpacity
            ...
            onPress={() => Linking.openURL(`https://wa.me/55${detalhes.profissional.telefone.replace(/\D/g, '')}`)}
          >
